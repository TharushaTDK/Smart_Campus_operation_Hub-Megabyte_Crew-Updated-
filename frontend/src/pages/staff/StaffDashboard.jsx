            ...
            <div className="relative z-10 pt-32 pb-32 px-6 max-w-6xl mx-auto flex flex-col justify-center min-h-[90vh]">
                <div className="max-w-2xl text-white">
                    ...
                    <p className="text-gray-100 text-lg leading-relaxed mb-10 pl-1 border-l-4 border-blue-500 max-w-xl">
                        ...
                        Handle your maintenance tasks effortlessly. {user?.department ? `Department: ${user.department}` : ''}
                    </p>

                    <Link to="/maintenance" className="inline-block px-8 py-3.5 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-[30px] transition-colors shadow-lg tracking-wider text-sm mt-2">
                        MAINTENANCE THINGS
                    </Link>
                </div>
            </div>
